...
type: 理工
levels: ['985', '211', '双一流']
tags: [冶金, 材料, 自动化, 老牌工科, 转专业宽松, 生活成本低]
established: 1923
campuses: [南湖校区, 浑南校区]
...
dorm:
  ...
  items:
    - name: 床铺尺寸
      content: 资料库收录《东北大学宿舍床尺寸》PDF，包含床铺长宽规格，购置床品前建议先核对所在校区与楼栋的具体尺寸。
    - name: 入学与生活指南
      content: 《freshman4NEU_2026》《8.12新生入学讲》等资料覆盖报到流程、校园生活与注意事项，可结合校园视频查看真实环境。
  sources:
    - 东北大学宿舍床尺寸.pdf（夸克网盘）
    - freshman4NEU_2026.pdf（夸克网盘）

classes:
  summary: 选课与教学制度已有官方文件可查：大学英语分级教学办法、本科生选课指导手册、选修课榜单与高数教材配套资源。
  points:
    - title: 大学英语分级教学
      content: 依据《东北大学〈大学英语〉课程分级教学实施办法（试行）》，英语课程实行分级教学，具体分级标准与晋级规则见文件原文。
    - title: 选课指导
      content: 《东北大学本科生选课指导手册》与《选修课榜单》可帮助了解选课流程、时间节点与课程评价。
    - title: 公共课学习资源
      content: 《高等数学（上）》教材与配套《习题全解指南（答案）》已收录，可提前评估课程难度。
  sources:
    - 东北大学〈大学英语〉课程分级教学实施办法（试行）
    - 东北大学本科生选课指导手册.pdf
    - 选修课榜单 ver.230810.2313.xlsx

trainingPlan:
  summary: 各学院本科生专业培养方案已收录于资料库（夸克网盘，提取码 DKVL），包含学分要求、课程结构与毕业条件。
  points:
    - title: 覆盖学院
      content: 工商管理、信息科学、理学、机械、文法、软件、冶金、马克思主义、医学与生物信息、外国语、生命科学、江河建筑、机器人科学等学院。
    - title: 使用提示
      content: 培养方案是了解专业课程与学分结构的第一手材料，可与转专业政策、保研细则配套阅读。
  sources:
    - 各学院本科生各专业培养方案（夸克网盘 96875988ef30 / DKVL）

clubs:
  summary: 东北大学的社团与学生组织体系完善，覆盖学术科技、文化艺术、体育健身、志愿服务与创新创业等方向，入学后可在每年 9-10 月的“百团大战”招新季加入。
  items:
    - name: 学生会与学生社团联合会
      content: 校学生会与社团联合会统筹全校学生活动；各学院设院级学生会，负责迎新、文体活动与权益服务。
    - name: 代表性社团
      content: 学术竞赛类有机器人、ACM 程序设计、数学建模等社团；文艺类有街舞、话剧、音乐社；运动类有篮球、羽毛球、滑雪等；还有支教与社区服务等志愿公益社团。
    - name: 招新方式
      content: 每年 9-10 月举办“百团大战”集中招新，多数社团零门槛加入；部分竞赛社团需要面试或基础考核。
    - name: 第二课堂
      content: 社团活动可计入第二课堂学分，参与组织工作还能积累学生工作经历，对评优与保研综合加分有帮助。
  sources:
    - 东北大学学生社团联合会公开资料
