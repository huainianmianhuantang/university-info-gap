...
brief: 百年综合性大学，人文底蕴深厚，校园环境优美，多个学部校区相邻。（示例内容，需核实）
featured: true
cover: /images/cover-whu.svg
...
secondarySelection:
  ...
  programs:
    - name: 弘毅学堂
      content: 设理科、工科、人文、社科等试验班，进校后选拔，小班制、导师制培养。
    - name: 学院特色班
      content: 部分学院设有拔尖或卓越班，依据成绩与面试二次选拔。
  sources:
    - 示例：来源于学校官网公开信息

trainingPlan:
  summary: 大类招生与专业分流并行，通识课程体系完善。（示例内容）
  points:
    - title: 大类与分流
      content: 部分专业按大类招生，大一学习通识与基础课后分流。
    - title: 通识教育
      content: 开设大量通识选修课，鼓励跨学科修读与辅修。
  sources:
    - 示例：需以培养方案为准

dorm:
  summary: 各学部宿舍条件不一，新宿舍楼条件较好。（示例内容）
  items:
    - name: 文理学部
      content: 多为 4 人间，部分宿舍带独卫，空调已普遍安装（示例数据）。
    - name: 医学部
      content: 新建宿舍条件较好，部分为 4 人间独立卫浴（示例数据）。
  sources:
    - 示例：来源于在校生反馈

classes:
  summary: 课程资源丰富，通识选修多，课堂氛围活跃。（示例内容）
  points:
    - title: 课堂规模
      content: 热门通识课与基础课人数多，专业课与研讨课人数较少。
    - title: 校园生活
      content: 樱花季校园人流量大，日常校园活动丰富（示例体验）。
  sources:
    - 示例：来源于在校生经验分享
...
学校以文、理见长，法学、测绘、水利等学科实力突出；校园坐拥珞珈山、东湖水，环境在全国高校中名列前茅。

选校提示（示例）：武大学科面广、校园生活丰富，适合偏好人文氛围与综合发展的考生；填报前建议关注具体专业的学科评估结果。
